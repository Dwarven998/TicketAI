...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <main class="dashboard-content">
            ...
            <?php if ($message): ?>
                <div class="alert alert-success alert-dismissible fade show border-0 shadow-sm rounded-3 flex-shrink-0" role="alert">
                            ...
                            <div class="card-body p-4 text-center">
                                ...
                                <div class="text-start border-top pt-3">
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <span class="text-dark fw-bold small">#<?php echo htmlspecialchars($user_data['user_number'] ?? $user_data['id']); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                            ...
                            <div class="card-body">
                                <form method="POST" id="profileInfoForm">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="phone" class="form-label text-muted small fw-semibold mb-1">Phone Number</label>
